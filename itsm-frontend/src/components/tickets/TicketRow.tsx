/**
 * TicketRow Component
 * Compact list-style ticket row for dense layouts
 */
...
export function TicketRow({ ticket, showPriority = false }: TicketRowProps) {
    ...
    return (
        <Link
            ...
            className="flex items-center gap-4 p-3 rounded-lg border border-surface-200 dark:border-surface-800 bg-white dark:bg-surface-900 hover:border-primary-300 dark:hover:border-primary-700 hover:bg-surface-50 dark:hover:bg-surface-800/80 transition-all group"
        >
            {/* Ticket Number */}
